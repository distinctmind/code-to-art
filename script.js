...
// create animated flower stalk that grows at random speed and moves in random directions
// we want the root to grow in all possible directions
class Root {
  constructor(x, y) {
    this.x = x;
    this.y = y;
...
// attach our drawing code to mouse position
